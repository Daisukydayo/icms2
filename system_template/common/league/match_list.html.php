            ...
            $.ajax({
                ...
                success: function(data) {
                    if(parseInt(data["result"])>0){
                        $("#span_state_"+id).html(formatState(data["state"]));
                        $("#span_state_"+id).css('color','green');
                        var result=data["match_result"];
                        $("#span_result_"+id).html(formatResult(result));
                        var homeGoal=data["home_goal"];
                        var guestGoal=data["guest_goal"];
...
<div class="div_list">
    ...
    <table width="100%" class="grid" cellpadding="0" cellspacing="0" id="left_tree">
        <tr class="grid_title">
            ...
            <td class="spe_line" style="width:80px;text-align:left;">比分</td>
            <td class="spe_line" style="width:70px;text-align:left;">结果</td>
