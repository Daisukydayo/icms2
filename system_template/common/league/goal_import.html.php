...
<script type="text/javascript">
    ...
    function GetIdsOfField(fieldName,queryFieldName,fieldIdName,method) {
        ...
        if(fieldName!=""&&jsonStr!=""){
            $.ajax({
                type: "post",
                url: "/default.php?secu=manage&mod="+method+"&m=async_get_json_with_ids&site_id={SiteId}&league_id={LeagueId}",
                data: {
                    ...
                    <div id="check">
                        <div class="div_list" id="container">
                            <ul id="sort_grid">
                                ...
                                <li><span class="btn">4</span></li>
                            </ul>
                        </div>

                        <div id="into" class="div_list">
                            <ul >
                                <li idvalue="f_MatchId" class="">比赛ID</li>
                                <li idvalue="MatchName" title="MatchName" id_name="f_MatchId" mod="match" class="btn2">比赛名</li>
                                <li idvalue="f_TeamId" >队ID</li>
                                <li idvalue="TeamName" title="TeamName" id_name="f_TeamId" mod="team" class="btn2">队名</li>
                                <li idvalue="f_MemberId" >进球者ID</li>
                                <li idvalue="MemberName" title="MemberName" id_name="f_MemberId" mod="member" class="btn2">进球者</li>
                                <li idvalue="f_AssistorId" >助攻者ID</li>
                                <li idvalue="AssistorName" title="AssistorName" id_name="f_AssistorId" mod="member" class="btn2">助攻者</li>
                                <li idvalue="f_Type" >类别ID</li>
                                <li idvalue="TypeName" title="TypeName" class="btn2">类别</li>
                                <li idvalue="MinuteInMatch" >时间</li>
                            </ul>
                        </div>
