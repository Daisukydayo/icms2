...
class PublishLogManageData extends BaseManageData
{
     ...
     * @return int 新增结果
     */
    public function Create($transferType=0, $tableType=0, $tableId=0, $destinationPath="", $sourcePath="", $transferTime, $transferResult=0)
    {
        $manageUserId=Control::GetManageUserId();
        $sql = "INSERT INTO " . self::TableName_PublishLog . "
                (TransferType,TableType,TableId,DestinationPath,SourcePath,TransferTime,TransferResult,ManageUserId,CreateDate)
                VALUES
                (:TransferType, :TableType,:TableId ,:DestinationPath, :SourcePath, :TransferTime, :TransferResult,:ManageUserId, now());";
