    ...
    private function AsyncSubmitOneMatch(){
        ...
        if(!empty($matchDetail)){
            ...
            if($result>0){
                ...
                parent::DelAllCache();
                $result.=',"home_goal":'.$homeGoal.',"guest_goal":'.$guestGoal.',"home_penalty":'.$homePenalty.',"guest_penalty":'.$guestPenalty.',"match_result":'.$resultMatch.',"home_stat":'.$homeStatistic.',"guest_stat":'.$guestStatistic.',"state":'.$state;
            }
